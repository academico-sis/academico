  ...
  methods: {
    saveAttendance: function saveAttendance(attendance) {
      ...
      axios.post(this.route, {
        ...
        /* todo fix this and update according to server response */
      })["catch"](function (e) {
        _this.errors.push(e);
      });
    }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getPhoneNumbers: function getPhoneNumbers() {
      ...
      axios.get('/student/' + this.student + '/phonenumbers').then(function (response) {
        _this.phoneables = response.data;
      });
      {}
    },
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getSkills: function getSkills() {
      ...
      axios.get('/course/' + this.course + '/getskills').then(function (response) {
    ...
    update: function update() {
      ...
      this.skills.map(function (skill, index) {
        skill.order = index + 1;
        axios.patch('/course/' + _this2.course + '/setskills', {
          skills: _this2.skills
        });
      });
    }
  }
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/attendance/studentAttendanceReportComponent.vue?vue&type=script&lang=js&":
/*!******************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/attendance/studentAttendanceReportComponent.vue?vue&type=script&lang=js& ***!
  \******************************************************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    absences: function absences() {
      ...
      var count = 0;
      Object.keys(this.attendances).forEach(function (attendance) {
        if (_this.attendances[attendance]['attendance_type_id'] == 3 || _this.attendances[attendance]['attendance_type_id'] == 4) {
          count++;
        }
      });
      return count;
    },
    partialpresence: function partialpresence() {
      var _this2 = this;

      var count = 0;
      Object.keys(this.attendances).forEach(function (attendance) {
        if (_this2.attendances[attendance]['attendance_type_id'] == 2) {
          count++;
        }
      });
      return count;
...
var render = function() {
  ...
  return _c("tr", [
    ...
    _vm._v(" "),
    _c("td", [_vm._v(_vm._s(_vm.event.start))]),
    _vm._v(" "),
    _c("td", [
      _c("div", { staticClass: "btn-group", attrs: { role: "group" } }, [
        ...
        _c(
          ...
          [
            _vm._v(
              "\n                " +
                _vm._s(_vm.$t("front.Partial Presence")) +
                " "
            ),
      ...
      _c("div", { staticClass: "btn-group", attrs: { role: "group" } }, [
        _c(
          "button",
          {
            ...
            attrs: { id: "", disabled: _vm.studentAttendance !== 4 },
            on: {
        ...
        _c(
          "button",
          {
            ...
            attrs: { id: "", disabled: _vm.studentAttendance !== 3 },
            on: {
              click: function($event) {
              ...
              _vm.newcomment != null
                ? _c(
                    "button",
                    {
                      ...
                      on: {
                        click: function($event) {
                          return _vm.saveComment(_vm.newcomment)
                        }
                      }
                    },
                    [_vm._v("Enregistrer")]
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/attendance/studentAttendanceReportComponent.vue?vue&type=template&id=1d8c5c20&":
/*!**********************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/attendance/studentAttendanceReportComponent.vue?vue&type=template&id=1d8c5c20& ***!
  \**********************************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
  ...
  return _c("div", [
    _c("div", { staticClass: "row" }, [
      _c("div", { staticClass: "col-sm-6 col-md-3" }, [
        _c("div", { staticClass: "card" }, [
          _c(
            "div",
            { staticClass: "card-body p-3 d-flex align-items-center" },
            [
              _c("i", {
                staticClass: "fa fa-user bg-primary p-3 font-2xl mr-3"
              }),
              _vm._v(" "),
              _c("div", [
                _c("div", { staticClass: "text-value-sm text-primary" }, [
                  _vm._v(_vm._s(_vm.attendanceratio) + "%")
                ]),
                _vm._v(" "),
                _c(
                  "div",
      ...
      _c("div", { staticClass: "col-sm-6 col-md-3" }, [
        _c("div", { staticClass: "card" }, [
          _c(
            ...
            [
              _c("i", {
                staticClass: "fa fa-clock-o bg-warning p-3 font-2xl mr-3"
              }),
              _vm._v(" "),
              _c("div", [
                _c("div", { staticClass: "text-value-sm text-primary" }, [
                  _vm._v(_vm._s(_vm.partialpresence()))
                ]),
                _vm._v(" "),
                _c(
                  "div",
                  ...
                  [_vm._v("@lang('Number of partial presences')")]
                )
              ])
            ]
          )
      ...
      _c("div", { staticClass: "col-sm-6 col-md-3" }, [
        _c("div", { staticClass: "card" }, [
          _c(
            ...
            [
              _c("i", {
                staticClass: "fa fa-user-times bg-danger p-3 font-2xl mr-3"
              }),
              _vm._v(" "),
              _c("div", [
                _c("div", { staticClass: "text-value-sm text-primary" }, [
                  _vm._v(_vm._s(_vm.absences()))
                ]),
                _vm._v(" "),
                _c(
                  "div",
                  ...
                  [_vm._v("@lang('Number of Absences')")]
                )
              ])
            ]
          )
    ...
    _c("div", { staticClass: "row" }, [
      _c(
        ...
        [
          _c("thead", [
            _c("th", [_vm._v(_vm._s(_vm.$t("Event")))]),
            _vm._v(" "),
            _c("th", [_vm._v(_vm._s(_vm.$t("Date")))]),
            _vm._v(" "),
            _c("th", [_vm._v(_vm._s(_vm.$t("Attendance status")))])
          ]),
          _vm._v(" "),
              ...
              [
                _c("absence-buttons", {
                  attrs: {
                    ...
                    route: _vm.storeattendanceroute,
...
Vue.component('student-attendance-report', __webpack_require__(/*! ./components/attendance/studentAttendanceReportComponent.vue */ "./resources/js/components/attendance/studentAttendanceReportComponent.vue")["default"]);
...
/***/ "./resources/js/components/attendance/studentAttendanceReportComponent.vue":
/*!*********************************************************************************!*\
  !*** ./resources/js/components/attendance/studentAttendanceReportComponent.vue ***!
  \*********************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _studentAttendanceReportComponent_vue_vue_type_template_id_1d8c5c20___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./studentAttendanceReportComponent.vue?vue&type=template&id=1d8c5c20& */ "./resources/js/components/attendance/studentAttendanceReportComponent.vue?vue&type=template&id=1d8c5c20&");
/* harmony import */ var _studentAttendanceReportComponent_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./studentAttendanceReportComponent.vue?vue&type=script&lang=js& */ "./resources/js/components/attendance/studentAttendanceReportComponent.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport *//* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _studentAttendanceReportComponent_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _studentAttendanceReportComponent_vue_vue_type_template_id_1d8c5c20___WEBPACK_IMPORTED_MODULE_0__["render"],
  _studentAttendanceReportComponent_vue_vue_type_template_id_1d8c5c20___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/attendance/studentAttendanceReportComponent.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/components/attendance/studentAttendanceReportComponent.vue?vue&type=script&lang=js&":
/*!**********************************************************************************************************!*\
  !*** ./resources/js/components/attendance/studentAttendanceReportComponent.vue?vue&type=script&lang=js& ***!
  \**********************************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_studentAttendanceReportComponent_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib??ref--4-0!../../../../node_modules/vue-loader/lib??vue-loader-options!./studentAttendanceReportComponent.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/attendance/studentAttendanceReportComponent.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport */ /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_studentAttendanceReportComponent_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/components/attendance/studentAttendanceReportComponent.vue?vue&type=template&id=1d8c5c20&":
/*!****************************************************************************************************************!*\
  !*** ./resources/js/components/attendance/studentAttendanceReportComponent.vue?vue&type=template&id=1d8c5c20& ***!
  \****************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_studentAttendanceReportComponent_vue_vue_type_template_id_1d8c5c20___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib??vue-loader-options!./studentAttendanceReportComponent.vue?vue&type=template&id=1d8c5c20& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/attendance/studentAttendanceReportComponent.vue?vue&type=template&id=1d8c5c20&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_studentAttendanceReportComponent_vue_vue_type_template_id_1d8c5c20___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_studentAttendanceReportComponent_vue_vue_type_template_id_1d8c5c20___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
