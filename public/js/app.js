...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  props: ["enrollment", "availablebooks", "availablefees", "availablediscounts", "availablepaymentmethods", "accountingenabled", "currency", "currencyposition", "productslist", "clients"],
  data: function data() {
    return {
      totalPrice: 0,
      errors: [],
      ...
      if (this.products) {
        this.products.forEach(function (product) {
          ...
          if (product.type === 'enrollment') {
            total -= _this.discount(parseFloat(product.price));
          }
        });
      }
  ...
  methods: {
    checkAccountingStatus: function checkAccountingStatus() {
      ...
      axios.get("/accountingservice/status").then(function (response) {
        return _this3.accountingServiceIsUp = response.data;
      });
    },
    ...
    finish: function finish() {
      ...
      axios.post("/checkout", {
        ...
        // handle success
        _this5.step = 4;
        window.location.href = "/enrollment/".concat(_this5.enrollment.id, "/show");
        new Noty({
          title: _this5.$t('Success'),
          text: _this5.$t("Your changes were successful"),
          type: "success"
        }).show();
      })["catch"](function (e) {
        ...
        new Noty({
          ...
          text: _this5.$t("Your changes could not be saved"),
          type: "error"
        }).show();
      });
    }
              ...
              [
                _c("cart-product-list-component", {
                  attrs: {
                    ...
                    totalDiscount: _vm.totalDiscount,
          ...
          _vm._l(_vm.products, function(product, index) {
            return _c("tr", { key: index }, [
              ...
              _c("td", [
                _vm._v(
                  "\n                        " +
                    _vm._s(product.price_with_currency) +
                    "\n                        "
                ),
                product.type === "enrollment" && _vm.discount(product.price) > 0
                  ? _c("span", { staticClass: "badge badge-info" }, [
                      _vm._v(" - "),
                      _vm.currencyposition === "before"
                        ? _c("span", [_vm._v(_vm._s(_vm.currency) + " ")])
                        : _vm._e(),
                      _vm._v(" " + _vm._s(_vm.discount(product.price)) + " "),
                      _vm.currencyposition === "after"
                        ? _c("span", [_vm._v(_vm._s(_vm.currency) + " ")])
                        : _vm._e()
                    ])
