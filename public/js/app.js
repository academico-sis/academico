            ...
            _c("div", { staticClass: "modal-content" }, [
              ...
              _c("div", { staticClass: "modal-body" }, [
                  ...
                  directives: [
                    {
                      name: "model",
                      rawName: "v-model",
                      value: _vm.comment_private,
                      expression: "comment_private"
                    }
                  ],
                  attrs: { type: "checkbox", name: "private", id: "private" },
                  domProps: {
                    checked: Array.isArray(_vm.comment_private)
                      ? _vm._i(_vm.comment_private, null) > -1
                      : _vm.comment_private
                  },
                  on: {
                    change: function($event) {
                      var $$a = _vm.comment_private,
                        $$el = $event.target,
                      ...
                      if (Array.isArray($$a)) {
                        var $$v = null,
                          $$i = _vm._i($$a, $$v)
                        if ($$el.checked) {
                          $$i < 0 && (_vm.comment_private = $$a.concat([$$v]))
                        } else {
                          $$i > -1 &&
                            (_vm.comment_private = $$a
                              .slice(0, $$i)
                              .concat($$a.slice($$i + 1)))
                        }
                      } else {
                        _vm.comment_private = $$c
                      }
                    }
                  }
                }),
                ...
                _c("label", { attrs: { for: "private" } }, [
                  _vm._v("Make the comment private")
                ])
              ]),
              _vm._v(" "),
        ...
        _c(
          ...
          _vm._l(_vm.skills, function(skill) {
            return _c("tr", { key: skill.id }, [
              _c("td", { staticStyle: { width: "50%" } }, [
                _vm._v(_vm._s(skill.name) + " " + _vm._s(skill.id))
              ]),
              _vm._v(" "),
              _c("td", [
                _c(
                    ...
                    _c(
                      ...
                      [
                        _c(
                          ...
                          {
                            staticClass: "btn btn-secondary",
                            class: { "btn-success": skill.status == 3 },
                            on: {
                              click: function($event) {
                                _vm.saveSkillStatus(skill.id, 3)
                              }
                            }
                          },
                          [
                    ...
                    _c(
                      ...
                      [
                        _c(
                          ...
                          {
                            staticClass: "btn btn-secondary",
                            class: { "btn-warning": skill.status == 2 },
                            on: {
                              click: function($event) {
                                _vm.saveSkillStatus(skill.id, 2)
                              }
                            }
                          },
                          [
                    ...
                    _c(
                      ...
                      [
                        _c(
                          ...
                          {
                            staticClass: "btn btn-secondary",
                            class: { "btn-danger": skill.status == 1 },
                            on: {
                              click: function($event) {
                                _vm.saveSkillStatus(skill.id, 1)
                              }
                            }
                          },
                          [
