  ...
  computed: {
    shoppingCartTotal: function shoppingCartTotal() {
      return this.books.map(function (item) {
        ...
        return total + amount;
      }) + this.fees.map(function (item) {
        return parseFloat(item.price);
      }).reduce(function (total, amount) {
        return total + amount;
      }) + this.enrollments.map(function (item) {
        return parseFloat(item.course.price);
      }).reduce(function (total, amount) {
        return total + amount;
      });
    }
...
var render = function() {
  ...
  return _c("div", { staticClass: "box" }, [
    ...
    _c("div", { staticClass: "box-body" }, [
      ...
      _vm._v(" "),
      _c("p", [_vm._v("Total: " + _vm._s(_vm.shoppingCartTotal))])
    ])
  ])
}
var staticRenderFns = [
...
__webpack_require__(/*! /home/afc/academico/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /home/afc/academico/resources/sass/app.scss */"./resources/sass/app.scss");
