  ...
  methods: {
    ...
    finish: function finish() {
      ...
      axios.post("/checkout", {
        ...
        // handle success
        _this4.step = 4;
        window.location.href = _this4.enrollment ? "/enrollment/".concat(_this4.enrollment.id, "/show") : "/payment";
        new Noty({
