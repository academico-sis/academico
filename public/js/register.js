...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
      ...
      return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                if (_this2.validateBase64(_this2.userPicture.substring(23))) {
                  _this2.updateData();
                } else {
                  _this2.$buefy.toast.open({
    ...
    // elements.
    validateBase64: function validateBase64(string64) {
      ...
      _c(
        ...
        [
          ...
          _c(
            "b-step-item",
            {
              attrs: { label: _vm.$t("step3"), clickable: _vm.activeStep > 2 }
            },
...
var store = {
  state: (_state = {
    ...
    phonenumber: null,
    tc_consent: false
  }, _defineProperty(_state, "address", null), _defineProperty(_state, "birthdate", null), _defineProperty(_state, "profession", null), _defineProperty(_state, "institution", null), _defineProperty(_state, "userPicture", null), _defineProperty(_state, "contacts", []), _state),
