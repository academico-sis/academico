...
if (file_exists(__DIR__.'/../../../../../permissionmanager/src/resources/lang/'.basename(__DIR__).'permissionmanager.php/'.basename(__FILE__))) {
    return include __DIR__.'/../../../../../permissionmanager/src/resources/lang/'.basename(__DIR__).'permissionmanager.php/'.basename(__FILE__);
}
