        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                @if (config('certificates-generation.supported') && $enrollment->result && backpack_user()->hasRole(['admin', 'secretary']))
                    <a href="{{ route('enrollment-export-result', ['enrollment' => $enrollment->id]) }}" class="btn btn-primary @if($enrollment->enrollmentStatus->id !== 1 && $enrollment->result->result_type_id !== 1) disabled @endif">@lang('Generate grade report')</a>
