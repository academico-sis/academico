                ...
                <form class="col-md-12 p-t-10" role="form" method="POST" action="{{ route('backpack.auth.register') }}">
                    ...
                    <div class="form-group{{ $errors->has('rules') ? ' has-error' : '' }}">
                        ...
                        <div>
                            ...
                            <label for="rules">He leído y acepto los términos y condiciones del <a target="blank" href="https://academico.afcuenca.org.ec/reglamento.pdf">Reglamento interno de la Alianza Francesa de Cuenca</a></label>{{-- todo allow config here --}}
                            @if ($errors->has('rules'))
                            <span class="help-block">
                    ...
                    <div class="form-group{{ $errors->has('invoice_data') ? ' has-error' : '' }}">
                        ...
                        <div>
                            ...
                            <label for="invoice_data">Quiero ingresar otros datos para la factuar</label>    
