    ...
    <div class="col-md-4">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <enrollment-price-field :enrollment="{{ json_encode($enrollment) }}" currency="{{ config('app.currency_symbol') }}" currencyposition="{{ config('app.currency_position') }}"></enrollment-price-field>
