<template>
    <tr>
        <td>
            <a v-if="this.attendanceEnabled" :href="courseattendanceroute">{{
                coursename
            }}</a>
        ...
        <td>
            ...
            >
                <input
                    v-model="attendanceEnabled"
                    class="switch-input"
                    :disabled="!isadmin"
                    type="checkbox"
                    @click="toggleAttendanceStatus(attendanceEnabled)"
                />
                <span
                    class="switch-slider"
                    data-checked="On"
