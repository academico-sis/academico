...
/**
 * @see \App\Http\Controllers\Admin\CouponCrudController
 */
class CouponCrudControllerTest extends TestCase
{
    ...
    public function destroy_returns_an_ok_response()
    {
        ...
        $response = $this->delete(route('coupon.destroy', ['id' => $id]));
    ...
    public function edit_returns_an_ok_response()
    {
        ...
        $response = $this->get(route('coupon.edit', ['id' => $id]));
    ...
    public function search_returns_an_ok_response()
    {
        ...
        $response = $this->post(route('coupon.search'), [
    ...
    public function show_details_row_returns_an_ok_response()
    {
        ...
        $response = $this->get(route('coupon.showDetailsRow', ['id' => $id]));
    ...
    public function update_returns_an_ok_response()
    {
        ...
        $response = $this->put(route('coupon.update', ['id' => $id]), [
            // TODO: send request data
        ]);
