...
class GradeTypeCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\GradeType');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/gradetype');
        $this->crud->setEntityNameStrings('gradetype', 'grade_types');
