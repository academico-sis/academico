...
class EvaluationTypeCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\EvaluationType');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/evaluationtype');
        $this->crud->setEntityNameStrings('evaluationtype', 'evaluation_types');
