...
class MigrateInvoices extends Command
{
     ...
     public function handle()
    {
        ...
        {
            // if the pre-invoice has been migrated
            if(PreInvoice::where('id', $detail->id_pre_factura_cabecera)->count() > 0)
            {
        ...
        ->select(DB::raw('
            ...
            ->where('id_prefactura', null) // this means since the new system is in prod
        ->get();
